    ...
    <section className="py-12 sm:py-16 md:py-20 px-3 sm:px-4 md:px-6 bg-[#FAFAFA]">
      <div className="container mx-auto">
        <div
          ...
          className="group relative w-full overflow-hidden rounded-2xl sm:rounded-[2rem] md:rounded-[3rem] bg-emerald-950 shadow-xl md:shadow-2xl transition-all duration-500 hover:shadow-[0_20px_60px_-15px_rgba(16,185,129,0.3)]"
        >
          ...
          {/* Content Container */}
          <div className="relative z-10 px-5 py-16 sm:px-8 sm:py-20 md:py-24 md:px-12 lg:py-32 lg:px-20 text-center">

            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-6 sm:mb-8"
            >
              <Sparkles size={12} className="sm:w-3.5 sm:h-3.5 text-emerald-400" />
            ...
            <p className="max-w-2xl mx-auto text-sm sm:text-base md:text-lg lg:text-xl text-slate-400 mb-8 sm:mb-10 md:mb-12 leading-relaxed px-2">
            ...
            <Link href="/contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="relative group/btn inline-flex items-center gap-3 sm:gap-4 px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-full bg-white text-emerald-950 font-bold text-sm sm:text-base md:text-lg tracking-wide shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_40px_rgba(255,255,255,0.5)] transition-all duration-300"
              >
                <span className="relative z-10">Start the Conversation</span>
                <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full bg-emerald-950 text-white flex items-center justify-center group-hover/btn:rotate-45 transition-transform duration-300">
