...
const Navbar = () => {
  ...
  const isLightMode = pathname === "/design-2" || pathname === "/design-6";
        ...
        */}
        ...
        >
          ...
          >
             ...
             <div className={`absolute inset-[1.5px] backdrop-blur-xl rounded-full border ${
               isLightMode 
          ...
          >
            <div className="hidden md:flex items-center gap-1">
              ...
              {/* CTA Button */}
              <motion.div layout="position" className={`ml-2 ${
                isScrolled 
                  ? "" 
                  : isLightMode 
                ...
                <Magnetic>
                  <button className={`hidden md:flex px-5 py-2 text-sm font-bold rounded-full hover:bg-[#00dc82] transition-colors items-center gap-2 shadow-lg hover:shadow-[#00dc82]/20 cursor-pointer ${
                    isLightMode 
                      ? "bg-black text-white" 
                      : "bg-white text-black"
                  }`}>
       ...
       <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className={`fixed inset-0 z-[60] backdrop-blur-xl flex flex-col items-center justify-center ${
             ...
             <div className="flex flex-col items-center gap-6">
                ...
                <motion.button
                   ...
                   transition={{ delay: 0.5 }}
                     className={`px-8 py-3 text-xl font-bold rounded-full hover:bg-[#00dc82] transition-colors ${
