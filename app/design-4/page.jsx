...
export default function Design4Hero() {
  ...
  return (
    <div 
      ref={containerRef} 
      className="relative min-h-screen w-full overflow-x-hidden bg-[#050505] text-white selection:bg-emerald-500 selection:text-black"
      onMouseMove={(e) => {
    ...
    >
      {/* Loading Curtain */}
      <div className="overlay-curtain absolute inset-0 z-50 bg-emerald-950 w-full h-full bottom-0" />
