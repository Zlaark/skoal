...
const Card = ({ card }) => {
  ...
  return (
    <div className="group relative h-[480px] w-[360px] md:w-[420px] overflow-hidden rounded-[2rem] flex-shrink-0 bg-[#0A261D] border border-emerald-900/30 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-900/50 hover:-translate-y-2">
  ...
  return (
    <section ref={targetRef} className="relative h-[300vh] bg-[#FAFAFA]">
      ...
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        {/* Section Header - Sticky at top LEFT */}
        {/* Adjusted left-10 md:left-24 to fix cut-off issue */}
        <div className="absolute top-12 left-10 md:left-24 z-20 max-w-lg">
        ...
        <div className="w-full relative z-10 pt-48 md:pt-64">
          <motion.div
            style={{ x }}
